...
export class HomePage implements OnInit, AfterViewInit {
  ...
  apiKey = 'af9299772ac94f2184ae4536d1649053';  // API Key OpenCage
  ...
  async updateLocation() {
    try {
      ...
      this.http.post('https://9c58d12d-8699-4675-8180-5c722855664e-00-oam5fqqaxeq6.pike.replit.dev/', body, { headers }).subscribe(
        response => {
  ...
  async getParentLocation() {
    this.http.get('https://9c58d12d-8699-4675-8180-5c722855664e-00-oam5fqqaxeq6.pike.replit.dev/?role=parent').subscribe(
      (response: any) => {
